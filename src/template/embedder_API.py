...
headers = {
    ...
    'Token-id': 'MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAJ118i5OgOqroz+Wn5mWwI13O8vFz6OFCAWk7Zymb2p5wq/XsMqqwFhEfWlo1jGxFG2lcbWNSUSaGenMP/TdmI8CAwEAAQ==',
    'Token-key': '4525a88b-e821-4f0c-e063-62199f0a3a11',
...
response = requests.post('https://api.idg.vnpt.vn/data-service/v1/chat/completions/vnptai-hackathon-embedding', headers=headers)
print(response)